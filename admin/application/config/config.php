...
|
*/
$config['base_url'] = 'http://localhost/group_deal/admin/';
...
$config['aws_access_key'] = 'AKIA3T4R77ICX3RGJPYW';
$config['aws_secret_key'] = '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';
$config['aws_bucket'] = 'adsnew';
$config['aws_url'] = 'https://adsnew.s3.ap-south-1.amazonaws.com/';
$config['aws_path'] = 'groupdeal/';
